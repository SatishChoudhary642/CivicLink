...
export const issues: Issue[] = [
  ...
  {
    id: 'pune-8',
    title: 'Faded Zebra Crossing at Swargate',
    description: 'The zebra crossing at the main Swargate bus stand junction is completely faded. Pedestrians have a very hard time crossing the busy road.',
    category: 'Damaged Sign',
    status: 'Resolved',
    imageUrl: 'https://picsum.photos/seed/zebracross/600/400',
    imageHint: 'zebra crossing',
    location: {
      lat: 18.500,
      lng: 73.865,
